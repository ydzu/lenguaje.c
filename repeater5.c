...
main(){
  ...
  for(i=0;i<30;i=i+3){
    drawCross(i+30,30,8+(0.6*i),theCanvas);
    drawCross(30-i,30,8+(0.6*i),theCanvas);
    drawCross(i+30,30,8+(0.6*i),theCanvas);
    drawCross(i+30,30-i,8+(0.6*i),theCanvas);
  }
  ...
  for(i=0;i<22;i=i+3){
    ...
    drawCircle(i*2+30,i*2+30,k,theCanvas);
  }
  for(i=0;i<22;i=i+3){
    k=2*(i/4);
    if (k>6){
  ...
  for(i=0;i<22;i=i+3){
    ...
    drawCircle(i*2+0,i*2+40,k,theCanvas);
  }
  drawCircle(20,10,16,theCanvas);
  drawCircle(60,20,16,theCanvas);
