...
char* concat(char *p, char *q)
{
  ...
  r1 = (char*)malloc ((j+k) * sizeof(char)); //reserva memoria para el nuevo puntero a array de caracteres. que es el largo de p + q
...
char* arrayGen(){
  ...
  p1 = (char*)malloc (n * sizeof(char)); //reserva memoria según el largo que se ingresa en n
